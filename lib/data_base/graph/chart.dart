...
filterFunction() async {
  ...
  for (var element in list) {
    if (element.category.type == CategoryType.icome) {
  ...
  for (var element in list) {
    ...
    if (elementDate == today && element.type == CategoryType.icome) {
      incomeTodayNotifier.value.add(element);
    }

    if (elementDate == yesterday && element.type == CategoryType.icome) {
    ...
    if (element.date.isAfter(
        ...
        element.type == CategoryType.icome) {
